...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        for i in range(COIN_COUNT):
            ...
            coin.center_y = random.randrange(80, SCREEN_HEIGHT)
    ...
    def on_mouse_press(self, x, y, button, modifiers):
        bullet = arcade.Sprite("../Lab 08 - Sprites/laserBlue01.png", SPRITE_SCALING_LASER)
        bullet.right = self.player_sprite.left + 30
        bullet.angle = 90
